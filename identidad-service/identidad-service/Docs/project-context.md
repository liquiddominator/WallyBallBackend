# Identidad Service - Contexto Funcional

`identidad-service` es el microservicio responsable de identidad, autenticacion, autorizacion y gestion administrativa base de accesos para el sistema WallyBall.
