# Endpoints Identidad Service

Este documento concentra los endpoints HTTP de `identidad-service`. El contexto funcional, epicas e historias viven en `project-context.md`.
