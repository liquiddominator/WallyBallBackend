...
using IdentidadService.Api.OpenApi;
using IdentidadService.Application;
using IdentidadService.Infrastructure;
...
try
{
    ...
    builder.Services.AddSwaggerGen(options =>
    {
        ...
        {
            Title = "Identidad Service API",
            Version = "v1",
            Description = "API de identidad, autenticacion y autorizacion del sistema WallyBall."
        });
    ...
    if (app.Environment.IsDevelopment() || app.Environment.IsEnvironment("Docker"))
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Identidad Service API v1");
            options.RoutePrefix = "swagger";
            options.DocumentTitle = "Identidad Service API";
        });
    }
    ...
    app.Lifetime.ApplicationStarted.Register(() =>
    {
        ...
        {
            Log.Information("Identity API available at {Url}", url);
...
{
    Log.Fatal(exception, "The identity API terminated unexpectedly.");
}
finally
{
    Log.CloseAndFlush();
