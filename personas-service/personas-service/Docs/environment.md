...
- SQL Server para persistencia transaccional de personas e identidad.
...
```json
"ConnectionStrings": {
  "SqlServer": "Server=localhost,1433;Database=PersonasDb;..."
}
```

```json
"Jwt": {
  "Issuer": "PersonasService",
...
ConnectionStrings__SqlServer=Server=personas-sqlserver,1433;Database=PersonasDb;...
Jwt__Issuer=PersonasService
